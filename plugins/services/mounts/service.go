...
func init() {
	registry.Register(&plugin.Registration{
		...
		InitFn: func(ic *plugin.InitContext) (interface{}, error) {
			...
			return &service{mm: i.(mount.MountManager)}, nil
		},
	})
}
...
func (s *service) List(in *api.ListRequest, _ api.Mounts_ListServer) error {
	return errgrpc.ToGRPC(errdefs.ErrNotImplemented)
}
