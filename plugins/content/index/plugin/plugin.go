...
func init() {
	registry.Register(&plugin.Registration{
		...
		// Use the metadata-wrapped content store (not the raw content plugin)
		// so that blobs written by the indexed store (chunk-index payloads,
		// individual chunks) are visible to namespace-aware consumers such as
		// the block-cache handler and the diff service.
