...
func TestGCRoots(t *testing.T) {
	...
	alters := []alterFunc{
		...
		addImage("ns1", "image2", dgst(2), labels(string(labelGCSnapRef)+"overlay", "sn2")),
		addContent("ns1", dgst(1), nil),
		addContent("ns1", dgst(2), nil),
		addContent("ns1", dgst(3), nil),
		addContent("ns2", dgst(1), nil),
		addContent("ns2", dgst(2), labels(string(labelGCRoot), "always")),
		addSnapshot("ns1", "overlay", "sn1", "", nil),
		addSnapshot("ns1", "overlay", "sn2", "", nil),
		addSnapshot("ns1", "overlay", "sn3", "", labels(string(labelGCRoot), "always")),
	}
...
func TestGCRefs(t *testing.T) {
	...
	alters := []alterFunc{
		...
		addContent("ns1", dgst(2), nil),
		addContent("ns1", dgst(3), nil),
		addContent("ns1", dgst(4), labels(string(labelGCContentRef), dgst(1).String())),
		addContent("ns1", dgst(5), labels(string(labelGCContentRef)+".anything-1", dgst(2).String(), string(labelGCContentRef)+".anything-2", dgst(3).String())),
		addContent("ns1", dgst(6), labels(string(labelGCContentRef)+"bad", dgst(1).String())),
		addContent("ns2", dgst(1), nil),
		addContent("ns2", dgst(2), nil),
		addSnapshot("ns1", "overlay", "sn1", "", nil),
		addSnapshot("ns1", "overlay", "sn2", "sn1", nil),
		addSnapshot("ns1", "overlay", "sn3", "sn2", nil),
		addSnapshot("ns1", "overlay", "sn4", "", labels(string(labelGCSnapRef)+"btrfs", "sn1", string(labelGCSnapRef)+"overlay", "sn1")),
