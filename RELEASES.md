...
support the release. If no maintainers volunteer to the own the _LTS_ release after maintainers step
...
warnings are showing up, the configuration can be safely upgrade in 1.6 or 1.7 before upgrading to
