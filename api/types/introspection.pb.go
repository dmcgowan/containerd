...
var file_github_com_containerd_containerd_api_types_introspection_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x66, 0x2f, 0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x46, 0x0a,
...
var file_github_com_containerd_containerd_api_types_introspection_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_github_com_containerd_containerd_api_types_introspection_proto_goTypes = []interface{}{
	(*RuntimeVersion)(nil), // 0: containerd.types.RuntimeVersion
	(*RuntimeInfo)(nil),    // 1: containerd.types.RuntimeInfo
	nil,                    // 2: containerd.types.RuntimeInfo.AnnotationsEntry
	(*anypb.Any)(nil),      // 3: google.protobuf.Any
}
var file_github_com_containerd_containerd_api_types_introspection_proto_depIdxs = []int32{
	0, // 0: containerd.types.RuntimeInfo.version:type_name -> containerd.types.RuntimeVersion
	3, // 1: containerd.types.RuntimeInfo.options:type_name -> google.protobuf.Any
	3, // 2: containerd.types.RuntimeInfo.features:type_name -> google.protobuf.Any
	2, // 3: containerd.types.RuntimeInfo.annotations:type_name -> containerd.types.RuntimeInfo.AnnotationsEntry
